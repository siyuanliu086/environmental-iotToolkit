...
public class TVOCDeviceData implements IDeviceData {
    ...
    public String getMessage() {
        ...
        float o2_content = 14.913f;//0.71f + getRandomFixedData() / 18.0f;
        ...
        float gas_pa = 1.349f;//32f + getRandomFixedData();
        float waste_gas = 3600.0f;// + getRandomFixedData();
        float soot = 25.2100f;//18f + getRandomFixedData();
        float soot_zs = 63.6616f;//getRandomTemData();
        float so2 = 20.3400f;//9f + getRandomFixedData();
        float so2_zs = 51.0317f;//51f + getRandomFixedData();
        float nox = 50.5467f;//getRandomFixedData();
        float nox_zs = 125.0510f;//1 + getRandomFixedData() / 2.0f;
