...
public class IOTCheckMainWindow {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    IOTCheckMainWindow window = new IOTCheckMainWindow();
    ...
    private void initialize() {
        ...
        frame.setIconImage(Toolkit.getDefaultToolkit().getImage(IOTCheckMainWindow.class.getResource("/images/iot_icon.png")));
